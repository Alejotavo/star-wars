...
//List specific SPECIE
const apiUrlSpecie = "https://swapi.dev/api/species";

export async function fetchDataSpecie(id: number): Promise<any> {
    try {
      const response = await fetch(apiUrlSpecie  + '/' + id);
